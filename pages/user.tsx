  ...
  return (
    <div className="min-h-screen dark:bg-gray-900">
      ...
      {images.length >= IMAGES_LIMIT ? (
        <div>
          you cannot upload any more images (limit is {IMAGES_LIMIT} images)
        </div>
      ) : (
        <div
        ...
        >
          ...
          <div>you may upload {IMAGES_LIMIT - images.length} more images</div>
          <input
      ...
      {isUploaded && (
        <p style={{ color: "teal" }}>Successfully uploaded {name}!</p>
      )}
