			...
			<div>
				...
				>
					...
					<h2
						...
						>Please log in or sign up to gain access</h2>
					<h3
						style={{
							fontFamily: "Times New Roman",
							color: "teal",
							fontSize: "24px",
							paddingTop: "10px",
						}}>What is Rate My Loo?</h3>
					<h4	style={{
						fontFamily: "Times New Roman",
						color: "grey",
						fontSize: "24px",
					}}>Rate My Loo is a website where you can upload</h4>
					<h5	style={{
						fontFamily: "Times New Roman",
						color: "grey",
						fontSize: "24px",
					}}>images of your bathroom and compare your own to others!</h5>
					<h6	style={{
						fontFamily: "Times New Roman",
						color: "grey",
						fontSize: "24px",
					}}>Log in and see for yourself!</h6>
					<button id="myButton" onClick={handleButtonClick}>Log into FireBase</button>
