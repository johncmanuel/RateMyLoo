...
import Tailer from "../pages/Tailer";
	...
	return (
		...
		<div>
			...
			>
  				...
  				<h1 className="border-4 border-black-100 w-full h-100 p-10 text-center font-custom" style={{fontFamily: 'Times New Roman', color: 'white', fontSize: '24px'}}>
